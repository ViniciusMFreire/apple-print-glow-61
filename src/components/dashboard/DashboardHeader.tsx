      ...
      <div className="flex items-center gap-3 md:gap-4 w-full sm:w-auto">
        ...
        <div className="relative flex-1 sm:flex-none">
          ...
          <Input 
            ...
            className="pl-10 w-full sm:w-80 md:w-96 lg:w-[500px] bg-gray-50 border-0 text-sm hover:border-2 hover:border-verde-dark focus-visible:border-2 focus-visible:border-verde-dark transition-all duration-200"
          />
        </div>
      </div>
